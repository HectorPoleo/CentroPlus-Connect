...
public class UsuarioController {
    ...
    public ResponseEntity<Usuario> getById(
            @Parameter(description = "ID numérico del usuario", example = "1", required = true)
            @PathVariable int id) {
    ...
    @Operation(
        ...
        description = "Registra un nuevo socio en el sistema. El DNI y el email deben ser únicos."
    )
    @ApiResponses({
