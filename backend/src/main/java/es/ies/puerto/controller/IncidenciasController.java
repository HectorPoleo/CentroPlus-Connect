...
public class IncidenciasController {
    ...
    @Operation(
        ...
        description = "Devuelve todas las incidencias registradas, con su estado y descripción."
    )
    ...
    @Operation(
        ...
        description = "Devuelve los detalles completos de una incidencia: asunto, descripción, fecha y estado."
    )
    @ApiResponses({
    ...
    @Operation(
        ...
        description = "Crea una nueva incidencia asociada a un usuario con asunto, descripción y fecha."
    )
    @ApiResponses({
    ...
    public ResponseEntity<Incidencias> create(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(
                ...
                content = @Content(
                    schema = @Schema(implementation = Incidencias.class),
    ...
    @Operation(
        ...
        description = "Modifica el estado o descripción de una incidencia (p.ej. de 'abierta' a 'resuelta')."
    )
    @ApiResponses({
    ...
    public ResponseEntity<Incidencias> update(
            @Parameter(description = "ID de la incidencia a actualizar", example = "1")
            @PathVariable int id,
            @Valid @RequestBody Incidencias incidencia) {
    ...
    @Operation(
        ...
        description = "Elimina definitivamente una incidencia del registro."
    )
    @ApiResponses({
    ...
    public ResponseEntity<Void> delete(
            @Parameter(description = "ID de la incidencia a eliminar", example = "1")
            @PathVariable int id) {
