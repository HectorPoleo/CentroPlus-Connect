...
public class ActividadesController {
    ...
    @Operation(
        ...
        description = "Devuelve el catálogo completo de actividades disponibles con sus plazas."
    )
    ...
    @Operation(
        ...
        description = "Devuelve los detalles de una actividad específica, incluyendo plazas disponibles."
    )
    @ApiResponses({
    ...
    @Operation(
        ...
        description = "Añade una nueva actividad al catálogo del centro deportivo."
    )
    @ApiResponses({
    ...
    public ResponseEntity<Actividades> create(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(
                ...
                content = @Content(
                    schema = @Schema(implementation = Actividades.class),
    ...
    @Operation(
        ...
        description = "Modifica los datos de una actividad existente, como precio, plazas o duración."
    )
    @ApiResponses({
    ...
    @Operation(
        ...
        description = "Elimina una actividad del catálogo. Ten en cuenta que puede haber reservas asociadas."
    )
    @ApiResponses({
